...
export default function ContactCTA() {
  return (
    <section className="py-20 relative overflow-hidden text-gray-900 bg-[url('/images/about_bg.png')] bg-cover bg-center">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          <p className="text-gray-900 text-lg max-w-2xl mx-auto leading-relaxed">
            Get in touch with our engineering team today. We offer free technical consultations and system architecture reviews.
          </p>
